...
class MedicineFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerView = view.findViewById(R.id.rvMedicine)
        recyclerView.layoutManager = LinearLayoutManager(mContext) // You can use GridLayoutManager or other layout managers if needed
        ...
        searchView = view.findViewById(R.id.svMedicine)
    ...
    private fun getData(){
        list=sharedPrefManager.getMedicineList()
